(function() {
    ...
    education_detailsCtrl.$inject = ['$stateParams', '$http', '$timeout', 'famMessages', 'famConstants', 'userDetails', 'alertService', '$state'];

    function education_detailsCtrl($stateParams, $http, $timeout, famMessages, famConstants, userDetails, alertService, $state) {
        // var login = this;
