(function() {
    ...
    angular.module(FAM_CONTROLLER)
        .controller('monthly_statementCtrl', monthly_statementCtrl);
    monthly_statementCtrl.$inject = ['$stateParams', '$http', '$timeout', 'famMessages', 'famConstants', 'userDetails', 'alertService', '$state'];

    function monthly_statementCtrl($stateParams, $http, $timeout, famMessages, famConstants, userDetails, alertService, $state) {
        // var login = this;
