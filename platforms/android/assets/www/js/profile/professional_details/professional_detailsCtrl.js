(function() {
    ...
    angular.module(FAM_CONTROLLER)
        .controller('professional_detailsCtrl', professional_detailsCtrl);
    professional_detailsCtrl.$inject = ['$stateParams', '$http', '$timeout', 'famMessages', 'famConstants', 'userDetails', 'alertService', '$state'];

    function professional_detailsCtrl($stateParams, $http, $timeout, famMessages, famConstants, userDetails, alertService, $state) {
        // var login = this;
