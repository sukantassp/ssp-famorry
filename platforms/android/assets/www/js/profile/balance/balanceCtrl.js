(function() {
    ...
    balanceCtrl.$inject = ['$stateParams', '$http', '$timeout', 'famMessages', 'famConstants', 'userDetails', 'alertService', '$state'];

    function balanceCtrl($stateParams, $http, $timeout, famMessages, famConstants, userDetails, alertService, $state) {
        // var login = this;
