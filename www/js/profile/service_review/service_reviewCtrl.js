(function() {
    ...
    angular.module(FAM_CONTROLLER)
        .controller('service_reviewCtrl', service_reviewCtrl);
    service_reviewCtrl.$inject = ['$stateParams', '$http', '$timeout', 'famMessages', 'famConstants', 'userDetails', 'alertService', '$state'];

    function service_reviewCtrl($stateParams, $http, $timeout, famMessages, famConstants, userDetails, alertService, $state) {
        // var login = this;
